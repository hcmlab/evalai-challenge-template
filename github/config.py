...
CHALLENGE_CONFIG_VALIDATION_URL = "/challenges-api/challenges/challenge/challenge_host_team/{}/validate_challenge_config/"
CHALLENGE_CREATE_OR_UPDATE_URL = "/challenges-api/challenges/challenge/challenge_host_team/{}/create_or_update_github_challenge/"
EVALAI_ERROR_CODES = [400, 401, 406]
API_HOST_URL = "https://hcai.eu/challenges"
IGNORE_DIRS = [
    ".git",
    ".github",
    "github",
